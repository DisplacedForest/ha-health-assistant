...
\f\r"'\`<>=]|("|')|))|$)`,"g"),_t=/'/g,ft=/"/g,yt=/^(?:script|style|textarea|title)$/i,tt=r=>(t,...e)=>({_$litType$:r,strings:t,values:e}),l=tt(1),P=tt(2),Xt=tt(3),A=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),vt=new WeakMap,w=S.createTreeWalker(S,129);function xt(r,t){if(!X(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return pt!==void 0?pt.createHTML(t):t}var Bt=(r,t)=>{let e=r.length-1,s=[],i,a=t===2?"<svg>":t===3?"<math>":"",o=N;for(let d=0;d<e;d++){let n=r[d],p,m,h=-1,_=0;for(;_<n.length&&(o.lastIndex=_,m=o.exec(n),m!==null);)_=o.lastIndex,o===N?m[1]==="!--"?o=mt:m[1]!==void 0?o=gt:m[2]!==void 0?(yt.test(m[2])&&(i=RegExp("</"+m[2],"g")),o=x):m[3]!==void 0&&(o=x):o===x?m[0]===">"?(o=i??N,h=-1):m[1]===void 0?h=-2:(h=o.lastIndex-m[2].length,p=m[1],o=m[3]===void 0?x:m[3]==='"'?ft:_t):o===ft||o===_t?o=x:o===mt||o===gt?o=N:(o=x,i=void 0);let f=o===x&&r[d+1].startsWith("/>")?" ":"";a+=o===N?n+It:h>=0?(s.push(p),n.slice(0,h)+$t+n.slice(h)+$+f):n+$+(h===-2?d:f)}return[xt(r,a+(r[e]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]},L=class r{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let a=0,o=0,d=t.length-1,n=this.parts,[p,m]=Bt(t,e);if(this.el=r.createElement(p,s),w.currentNode=this.el.content,e===2||e===3){let h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(i=w.nextNode())!==null&&n.length<d;){if(i.nodeType===1){if(i.hasAttributes())for(let h of i.getAttributeNames())if(h.endsWith($t)){let _=m[o++],f=i.getAttribute(h).split($),g=/([.?@])?(.*)/.exec(_);n.push({type:1,index:a,name:g[2],strings:f,ctor:g[1]==="."?Y:g[1]==="?"?G:g[1]==="@"?J:E}),i.removeAttribute(h)}else h.startsWith($)&&(n.push({type:6,index:a}),i.removeAttribute(h));if(yt.test(i.tagName)){let h=i.textContent.split($),_=h.length-1;if(_>0){i.textContent=I?I.emptyScript:"";for(let f=0;f<_;f++)i.append(h[f],D()),w.nextNode(),n.push({type:2,index:++a});i.append(h[_],D())}}}else if(i.nodeType===8)if(i.data===bt)n.push({type:2,index:a});else{let h=-1;for(;(h=i.data.indexOf($,h+1))!==-1;)n.push({type:7,index:a}),h+=$.length-1}a++}}static createElement(t,e){let s=S.createElement("template");return s.innerHTML=t,s}};function k(r,t,e=r,s){if(t===A)return t;let i=s!==void 0?e._$Co?.[s]:e._$Cl,a=T(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(r),i._$AT(r,e,s)),s!==void 0?(e._$Co??=[])[s]=i:e._$Cl=i),i!==void 0&&(t=k(r,i._$AS(r,t.values),i,s)),t}var K=class{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??S).importNode(e,!0);w.currentNode=i;let a=w.nextNode(),o=0,d=0,n=s[0];for(;n!==void 0;){if(o===n.index){let p;n.type===2?p=new O(a,a.nextSibling,this,t):n.type===1?p=new n.ctor(a,n.name,n.strings,this,t):n.type===6&&(p=new Z(a,this,t)),this._$AV.push(p),n=s[++d]}o!==n?.index&&(a=w.nextNode(),o++)}return w.currentNode=S,i}p(t){let e=0;for(let s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}},O=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,e=this._$AM;return e!==void 0&&t?.nodeType===11&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=k(this,t,e),T(t)?t===c||t==null||t===""?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==A&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Vt(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&T(this._$AH)?this._$AA.nextSibling.data=t:this.T(S.createTextNode(t)),this._$AH=t}$(t){let{values:e,_$litType$:s}=t,i=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=L.createElement(xt(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{let a=new K(i,this),o=a.u(this.options);a.p(e),this.T(o),this._$AH=a}}_$AC(t){let e=vt.get(t.strings);return e===void 0&&vt.set(t.strings,e=new L(t)),e}k(t){X(this._$AH)||(this._$AH=[],this._$AR());let e=this._$AH,s,i=0;for(let a of t)i===e.length?e.push(s=new r(this.O(D()),this.O(D()),this,this.options)):s=e[i],s._$AI(a),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){let s=ut(t).nextSibling;ut(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},E=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,a){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=c}_$AI(t,e=this,s,i){let a=this.strings,o=!1;if(a===void 0)t=k(this,t,e,0),o=!T(t)||t!==this._$AH&&t!==A,o&&(this._$AH=t);else{let d=t,n,p;for(t=a[0],n=0;n<a.length-1;n++)p=k(this,d[s+n],e,n),p===A&&(p=this._$AH[n]),o||=!T(p)||p!==this._$AH[n],p===c?t=c:t!==c&&(t+=(p??"")+a[n+1]),this._$AH[n]=p}o&&!i&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},Y=class extends E{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}},G=class extends E{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}},J=class extends E{constructor(t,e,s,i,a){super(t,e,s,i,a),this.type=5}_$AI(t,e=this){if((t=k(this,t,e,0)??c)===A)return;let s=this._$AH,i=t===c&&s!==c||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,a=t!==c&&(s===c||i);i&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},Z=class{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){k(this,t)}};var jt=Q.litHtmlPolyfillSupport;jt?.(L,O),(Q.litHtmlVersions??=[]).push("3.3.3");var wt=(r,t,e)=>{let s=e?.renderBefore??t,i=s._$litPart$;if(i===void 0){let a=e?.renderBefore??null;s._$litPart$=i=new O(t.insertBefore(D(),a),a,void 0,e??{})}return i._$AI(r),i};var et=globalThis,b=class extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=wt(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}};b._$litElement$=!0,b.finalized=!0,et.litElementHydrateSupport?.({LitElement:b});var Wt=et.litElementPolyfillSupport;Wt?.({LitElement:b});(et.litElementVersions??=[]).push("4.2.2");function st(r,t=!1){let e=r.points;if(!e.length)return l`<div class="trend-empty">No readings in the last 14 days</div>`;let s=t?600:160,i=t?150:48,a=e.map(g=>g.v),o=Math.min(...a),d=Math.max(...a)-o||Math.abs(o)*.05||1,n=e.map(g=>new Date(g.t).getTime()),p=n[n.length-1]-n[0]||1,m=g=>6+(n[g]-n[0])/p*(s-12),h=g=>i-8-(g-o)/d*(i-16),_=[],f="";return e.forEach((g,y)=>{y&&g.source_changed&&(_.push(f),f=""),f+=`${f?" L":"M"}${m(y)},${h(g.v)}`}),_.push(f),l`<svg class="sparkline" viewBox="0 0 ${s} ${i}" role="img" aria-label="Recorded trend over 14 days. Lines break when the source changes.">
    ...
    <div class="metric-value">${r._metricValue(t.current,t.unit==="count"?0:1)}<span class="metric-source">${At(r,t)}</span></div>
    ...
    ${s?l`<section class="lead-change ${s.stale?"stale":""}">
      <div class="lead-copy"><p class="eyebrow">${s.state==="changed"&&!s.stale?"A change in your record":s.state==="conflict"?"Worth a closer look":"Your latest readings"}</p>
        ...
        <p class="sub">${r._providerName(s.current.provider)} · ${At(r,s)}</p>
    ...
    ${i.length?l`<section class="metric-section" aria-label="Health metrics"><div class="section-heading"><h2>The rest of your record</h2><span class="sub">Select a metric for readings and sources</span></div>${i.map(o=>St(r,o))}</section>`:c}
    ${a.length?l`<details class="missing-metrics"><summary>${a.length} ${a.length===1?"metric":"metrics"} without readings</summary><p class="sub">Connect a source, add a reading, or open a metric to restore an excluded record.</p>${a.map(o=>St(r,o))}</details>`:c}
...
`;var Ft=2.204622621848776,Kt=1/1609.344,V=[{key:"weight",label:"Weight"},{key:"body_fat_percentage",label:"Body fat"},{key:"lean_mass",label:"Lean mass"},{key:"steps",label:"Steps"},{key:"distance",label:"Distance"},{key:"active_energy",label:"Active energy"}],Yt=[7,30,90],rt={ha_entity:"Home Assistant sensors",manual:"Manual entries",withings:"Withings",fitbit:"Fitbit",hevy:"Hevy"},ot=class extends b{static properties={hass:{attribute:!1},narrow:{type:Boolean},panel:{attribute:!1},_overview:{state:!0},_loading:{state:!0},_detailMetric:{state:!0},_detail:{state:!0},_records:{state:!0},_showExcluded:{state:!0},_detailError:{state:!0},_detailLoading:{state:!0},_busyId:{state:!0},_series:{state:!0},_tab:{state:!0},_metric:{state:!0},_days:{state:!0},_error:{state:!0},_form:{state:!0},_saving:{state:!0}};constructor(){super(),this._tab="overview",this._metric="weight",this._days=30,this._form=null,this._saving=!1,this._loadedOnce=!1,this._showExcluded=!1,this._records=[],this._request=0,this._detailRequest=0,this._dialogSession=0}get _domain(){return this.panel&&this.panel.config&&this.panel.config.domain||"health_assistant"}get _imperial(){return!!(this.hass&&this.hass.config&&this.hass.config.unit_system&&this.hass.config.unit_system.length==="mi")}updated(t){t.has("hass")&&this.hass&&!this._loadedOnce&&(this._loadedOnce=!0,this._refresh())}connectedCallback(){super.connectedCallback(),this._timer=window.setInterval(()=>{this.hass&&!this._loading&&this._refresh()},6e4)}disconnectedCallback(){super.disconnectedCallback(),window.clearInterval(this._timer)}async _refresh(){let t=++this._request;this._loading=!0,this._error=void 0;try{let e=await this.hass.callWS({type:`${this._domain}/overview`});t===this._request&&(this._overview=e),this._tab==="trends"&&await this._loadSeries()}catch{t===this._request&&(this._error="Health data could not refresh. Check the integration and try again.")}finally{t===this._request&&(this._loading=!1)}}_providerName(t){return rt[t]||this._overview?.providers.find(e=>e.key===t)?.name||t.replaceAll("_"," ")}_label(t){return V.find(e=>e.key===t)?.label||t}async _openDetail(t,e){let s=++this._dialogSession;this._opener=e?.currentTarget,this._detailMetric=t,this._detail=void 0,this._showExcluded=!1,this._records=[],await this.updateComplete,s===this._dialogSession&&(this.shadowRoot.querySelector("dialog").showModal(),await this._loadDetail())}_closeDetail(){this._dialogSession++,this._detailRequest++,this.shadowRoot.querySelector("dialog")?.close(),this._detailMetric=void 0,this._opener?.focus()}async _loadDetail(t,e=!1){let s=++this._detailRequest,i=this._detailMetric;if(!i)return;this._detailLoading=!0,this._detailError=void 0;let a=this._overview?.metrics.find(o=>o.metric===i)?.current;try{let o=await this.hass.callWS({type:`${this._domain}/observations`,metric:i,excluded:this._showExcluded,limit:20,...e&&this._nextRecord?{before_id:this._nextRecord}:{}}),d=t||(this._showExcluded?o.observations[0]?.id:a?.id),n=d?await this.hass.callWS({type:`${this._domain}/observation_detail`,observation_id:d}):void 0;if(s!==this._detailRequest)return;this._records=e?[...this._records,...o.observations]:o.observations,this._nextRecord=o.next_before_id,this._detail=n}catch{s===this._detailRequest&&(this._detailError="That reading could not load. It may have changed during a sync. Try again.")}finally{s===this._detailRequest&&(this._detailLoading=!1)}}async _toggleExclusion(){let t=this._detail?.observation;if(!t||this._busyId)return;let e=this._dialogSession,s=this._detailRequest,i=()=>e===this._dialogSession&&s===this._detailRequest;this._busyId=t.id,this._detailError=void 0;try{await this.hass.callWS({type:`${this._domain}/observation_exclusion`,observation_id:t.id,excluded:!t.excluded}),await this._refresh(),i()&&(s++,await this._loadDetail(t.id))}catch{i()&&(this._detailError="The reading could not be changed. Refresh and try again.")}finally{this._busyId=void 0,await this.updateComplete,i()&&this.shadowRoot.querySelector(".exclusion-control button")?.focus()}}async _loadSeries(){let t=(this._seriesRequest||0)+1;this._seriesRequest=t,this._series=void 0;try{let e=await this.hass.callWS({type:`${this._domain}/time_series`,metric:this._metric,days:this._days});t===this._seriesRequest&&(this._series=e)}catch{t===this._seriesRequest&&(this._error="Trend data could not load. Try refreshing.")}}_setTab(t){this._tab=t,t==="trends"?this._loadSeries():this._refresh()}_setMetric(t){this._metric=t,this._loadSeries()}_setDays(t){this._days=t,this._loadSeries()}_display(t,e){return t==null?null:e==="kg"&&this._imperial?{value:t*Ft,unit:"lb"}:e==="m"&&this._imperial?{value:t*Kt,unit:"mi"}:e==="m"&&t>=1e3?{value:t/1e3,unit:"km"}:{value:t,unit:e}}_fmt(t,e=1){return new Intl.NumberFormat(void 0,{maximumFractionDigits:e}).format(t)}_when(t){let e=new Date(t),i=Math.floor((new Date-e)/864e5);return i<=0?e.toLocaleTimeString(void 0,{hour:"numeric",minute:"2-digit"}):i===1?"yesterday":i<7?`${i} days ago`:e.toLocaleDateString()}_metricValue(t,e=1){if(!t)return l`<span class="empty-value">no data</span>`;let s=this._display(t.value,t.unit),i=s.unit==="count"?c:l`<span class="unit">${s.unit}</span>`;return l`<span class="value">${this._fmt(s.value,e)}</span>${i}`}_defaultUnit(t){return t==="weight"||t==="lean_mass"?this._imperial?"lb":"kg":t==="distance"?this._imperial?"mi":"km":t==="body_fat_percentage"?"%":t==="active_energy"?"kcal":""}_localNow(t=0){let e=new Date(Date.now()-t*6e4),s=i=>String(i).padStart(2,"0");return`${e.getFullYear()}-${s(e.getMonth()+1)}-${s(e.getDate())}T${s(e.getHours())}:${s(e.getMinutes())}`}_openForm(t){this._error=void 0,this._form=this._form===t?null:t}_formValue(t){let e=this.shadowRoot.getElementById(t);return e?e.value.trim():""}async _submitMeasurement(t){t.preventDefault();let e=Number(this._formValue("m-value"));if(!Number.isFinite(e)){this._error="Enter a numeric value";return}let i={metric:this._formValue("m-metric"),value:e},a=this._formValue("m-unit");a&&a!=="count"&&(i.unit=a);let o=this._formValue("m-when");o&&(i.observed_at=new Date(o).toISOString()),await this._callAction("add_observation",i)}async _submitWorkout(t){t.preventDefault();let e=this._formValue("w-type"),s=this._formValue("w-start"),i=this._formValue("w-end");if(!e||!s||!i){this._error="Workout type, start, and end are required";return}let a={workout_type:e,start:new Date(s).toISOString(),end:new Date(i).toISOString()},o=this._formValue("w-title");o&&(a.title=o);let d=this._formValue("w-energy");d&&(a.energy_kcal=Number(d));let n=this._formValue("w-distance");n&&(a.distance=Number(n),a.distance_unit=this._imperial?"mi":"km"),await this._callAction("add_workout",a)}async _callAction(t,e){this._saving=!0,this._error=void 0;try{await this.hass.callService(this._domain,t,e),this._form=null,await this._refresh()}catch(s){this._error=s&&s.message||"Unable to save"}finally{this._saving=!1}}_measurementForm(){return this._form!=="measure"?c:l`
    ...
    `}_renderOverview(){return kt(this)}_chart(){let t=this._series;if(!t)return l`<p role="status">Loading trend…</p>`;if(t.points.length===0)return l`<p class="empty-value">
      ...
      </p>`;let e=640,s=260,i={left:54,right:16,top:16,bottom:34},a=t.points.map(u=>({time:new Date(u.t).getTime(),shown:this._display(u.v,t.unit),provider:u.provider})),o=a[0].shown.unit,d=a.map(u=>u.shown.value),n=a.map(u=>u.time),p=Math.min(...d),m=Math.max(...d),h=m-p||Math.abs(m)*.1||1,_=Math.min(...n),f=Math.max(...n),g=f-_||1,y=u=>i.left+(u-_)/g*(e-i.left-i.right),z=u=>s-i.bottom-(u-(p-h*.05))/(h*1.1)*(s-i.top-i.bottom),Mt=a.map((u,Dt)=>`${Dt===0?"M":"L"}${y(u.time).toFixed(1)},${z(u.shown.value).toFixed(1)}`).join(" "),Rt=a.length<=120?a.map(u=>P`<circle cx="${y(u.time)}" cy="${z(u.shown.value)}" r="3">
